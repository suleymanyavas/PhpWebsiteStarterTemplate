    ...
    <header>
        <nav class="navbar navbar-expand-lg bg-light text-white">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php"><img src="img/crownlogo.png" alt="logo"></a>
                    ...
                    <div>
                        ...
                        <div class="row">
                            ...
                            if (isset($_SESSION['userId'])) {
                                echo ('<div class="col"><form action="includes/logout.inc.php">
                        ...
                        <br> <a class="text-dark ml-2" href="signup.php">Signup</a>
                    </div>');
                            }
                            ?>
